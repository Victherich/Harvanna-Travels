...
const fetchAppVersion = async () => {
    try {
      const response = await fetch('https://harvannatravelsandtour.com/api/get_app_version.php'); // URL to the PHP backend
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => fetchAppVersion(),1*60*1000); // Poll every 5 minutes
